    ...
    array(
            ...
            "actions" => array(
                ...
                array(
                    ...
                    'action' => 'send_alert',
                    'params' => array(
                        'subject' => 'Follow-Up on Initial Discussion',
                        'from_address' => '@owner[login_name]@',
                        'to_addresses' => '@org_lead_party[main_location[email]]@', // client email to be looked up via client ID
            ...
            "actions" => array(
                array(
                    ...
                    'params' => array (
                        ...
                        'function_name' => 'retrieve_person_name',
                        'fields' => array (
                            'to_update' => array(
                                'linked_item_association_for_cf_opportunity_contact_name',
                                '_preload_linked_item_association_for_cf_opportunity_contact_name',
                                'cf_opportunity_contact_email',
                            ),
                            'to_retrieve' => array(
                                'id',
                                'name',
